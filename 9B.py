...
wb = openpyxl.load_workbook('4thsem2023.xlsx',data_only=True)
...
for row in range(1, sheet.max_row + 1):
    ...
    print("%4s %12s %20s %7s %7s %7s %7s% 7.2s"%(row,USN,Name, IAT1,IAT2,IAT3, Total,Avg))
